    ...
    return (
        <>
            <section className="bg-neutral-primary">
                <div className="py-8 px-4 mx-auto max-w-7xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
                    <div className="flex flex-col justify-center">
                        <h1 className="mb-6 text-4xl font-bold tracking-tighter text-heading md:text-5xl lg:text-6xl">Sign in</h1>
                    </div>
                    <div>
                        <div className="w-full bg-neutral-primary-soft p-6 border border-default rounded-base shadow-xs">
                            <form action="#">
                                ...
                                <button type="submit" className="text-white bg-blue-950 box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none w-full mb-3">Login to your account</button>
